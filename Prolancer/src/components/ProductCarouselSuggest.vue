          ...
          <div class="col-md-12">
            ...
            >
              ...
              <ol class="carousel-indicators">
                <li
                  data-target="#myCarouselSuggest"
                  data-slide-to="0"
                  class="listCarouse active"
                ></li>
                <li class="listCarouse " data-target="#myCarouselSuggest" data-slide-to="1"></li>
                <li class="listCarouse " data-target="#myCarouselSuggest" data-slide-to="2"></li>
              </ol>
